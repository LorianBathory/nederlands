...
- ⭐ — обязательно знать на уровне A1+: это наиболее частотный и полезный для повседневной речи материал из прочитанных текстов, который ещё не отмечен в `KNOWN.md` как изученный.
- ✅ — пользователь уже подтвердил этот материал как изученный; он оставлен здесь для полноты общего списка, но не включён в приоритет A1+.
- **OTT** (*onvoltooid tegenwoordige tijd*) — настоящее время. Формы даны в порядке `ik; jij/je; u; hij/zij/het; wij/jullie/zij`. Если несколько лиц имеют одну форму, они объединены.
- **Imperfectum** — простое прошедшее время: сначала единственное, затем множественное число.
- **Perfectum** — вспомогательный глагол и причастие прошедшего времени.
- У глаголов движения выбор **hebben** или **zijn** может зависеть от смысла: **zijn** обычно подчёркивает направленное перемещение или переход в новое состояние, **hebben** — деятельность без такой границы.

## Отдельные глаголы

| Приоритет | Инфинитив | Перевод | OTT | Imperfectum | Perfectum | Управление и особенности |
|---|---|---|---|---|---|---|
...
| ⭐ | **eruitzien** | выглядеть | zie eruit; ziet eruit; ziet eruit; ziet eruit; zien eruit | zag eruit; zagen eruit | heeft eruitgezien | Отделяемое **er...uit**; **er + прилагательное + uitzien**. |
| ⭐ | **gaan** | идти, ехать; переходить к действию | ga; gaat; gaat; gaat; gaan | ging; gingen | is gegaan | **gaan + infinitief** без **te**; направление часто с **naar**. |
| ⭐ | **gebeuren** | происходить | gebeur; gebeurt; gebeurt; gebeurt; gebeuren | gebeurde; gebeurden | is gebeurd | Обычно безлично: **er gebeurt iets**. |
| ⭐ | **geven** | давать | geef; geeft; geeft; geeft; geven | gaf; gaven | heeft gegeven | **iemand iets geven**. |
| ⭐ | **heten** | называться, зваться | heet; heet; heet; heet; heten | heette; heetten | heeft geheten | **Ik heet ...** — «Меня зовут…». |
| ⭐ | **kijken** | смотреть | kijk; kijkt; kijkt; kijkt; kijken | keek; keken | heeft gekeken | **naar iets/iemand kijken**. |
...
|  | **ophangen** | вешать, подвешивать | hang op; hangt op; hangt op; hangt op; hangen op | hing op; hingen op | heeft opgehangen | Отделяемое **op-**; **iets ophangen**. |
|  | **oppakken** | поднимать, брать в руки | pak op; pakt op; pakt op; pakt op; pakken op | pakte op; pakten op | heeft opgepakt | Отделяемое **op-**; **iemand/iets oppakken**. |
| ⭐ | **opstaan** | вставать | sta op; staat op; staat op; staat op; staan op | stond op; stonden op | is opgestaan | Отделяемое **op-**. |
|  | **piepen** | пищать | piep; piept; piept; piept; piepen | piepte; piepten | heeft gepiept | Без обязательного управления. |
|  | **pikken** | клевать | pik; pikt; pikt; pikt; pikken | pikte; pikten | heeft gepikt | **iets pikken**; **op de grond** в истории обозначает место, не управление. |
...
| ⭐ | **spelen** | играть | speel; speelt; speelt; speelt; spelen | speelde; speelden | heeft gespeeld | **met iemand spelen**. |
...
| ⭐ | **zeggen** | говорить, сказать | zeg; zegt; zegt; zegt; zeggen | zei; zeiden | heeft gezegd | **iets tegen iemand zeggen**; возможно придаточное с **dat**. |
...
## Глагольные выражения и конструкции

В формах ниже изменяется выделенный смысловой глагол; местоимения **iemand/iets** заменяются нужным объектом.

| Приоритет | Выражение | Перевод | OTT | Imperfectum | Perfectum | Модель |
|---|---|---|---|---|---|---|
| ⭐ | **houden van** | любить кого-либо/что-либо | houd van; houdt van; houdt van; houdt van; houden van | hield van; hielden van | heeft van ... gehouden | Обязательное **van**: **van iemand/iets houden**. |
| ⭐ | **gaan zitten** | садиться | ga zitten; gaat zitten; gaat zitten; gaat zitten; gaan zitten | ging zitten; gingen zitten | is gaan zitten | **gaan + infinitief** без **te**. |
| ⭐ | **liggen te slapen / liggen te + infinitief** | лежать и одновременно что-либо делать | lig te slapen; ligt te slapen; ligt te slapen; ligt te slapen; liggen te slapen | lag te slapen; lagen te slapen | heeft liggen slapen | В perfectum употребляется двойной инфинитив. |
| ⭐ | **pijn doen** | болеть; причинять боль | doe pijn; doet pijn; doet pijn; doet pijn; doen pijn | deed pijn; deden pijn | heeft pijn gedaan | **iemand pijn doen**; часть тела может быть подлежащим: **Mijn arm doet pijn**. |
| ⭐ | **op bezoek komen** | приходить в гости | kom op bezoek; komt op bezoek; komt op bezoek; komt op bezoek; komen op bezoek | kwam op bezoek; kwamen op bezoek | is op bezoek gekomen | Устойчивое дополнение **op bezoek**. |
| ⭐ | **erom lachen** / **om iets lachen** | смеяться над этим / над чем-либо | lach erom; lacht erom; lacht erom; lacht erom; lachen erom | lachte erom; lachten erom | heeft erom gelachen | Обязательное **om**; **om iets → erom**. |
| ⭐ | **iemand/iets met rust laten** | оставлять кого-либо/что-либо в покое | laat ... met rust; laat ... met rust; laat ... met rust; laat ... met rust; laten ... met rust | liet ... met rust; lieten ... met rust | heeft ... met rust gelaten | Объект стоит перед **met rust**. |
|  | **om iemand/iets heen lopen** | обходить кого-либо/что-либо | loop eromheen; loopt eromheen; loopt eromheen; loopt eromheen; lopen eromheen | liep eromheen; liepen eromheen | is eromheen gelopen | Рамка **om ... heen**; с неодушевлённым объектом возможно **eromheen**. |
| ⭐ | **zich/iemand mooi maken** | прихорашиваться / делать кого-либо красивым | maak me mooi; maakt je mooi; maakt zich mooi; maakt zich mooi; maken ons/jullie/zich mooi | maakte zich mooi; maakten zich mooi | heeft zich mooi gemaakt | Модель **maken + объект + прилагательное**. |
| ⭐ | **moeten lachen** | невольно рассмеяться, не удержаться от смеха | moet lachen; moet lachen; moet lachen; moet lachen; moeten lachen | moest lachen; moesten lachen | heeft moeten lachen | Здесь **moeten** выражает неизбежную реакцию, а не обязанность; двойной инфинитив в perfectum. |
| ⭐ | **vinden + прилагательное** | считать кого-либо/что-либо каким-либо | vind ... mooi; vindt ... mooi; vindt ... mooi; vindt ... mooi; vinden ... mooi | vond ... mooi; vonden ... mooi | heeft ... mooi gevonden | После объекта стоит характеристика: **zichzelf prachtig vinden**. |
| ⭐ | **blijven + infinitief** | продолжать что-либо делать | blijf liggen; blijft liggen; blijft liggen; blijft liggen; blijven liggen | bleef liggen; bleven liggen | is blijven liggen | Инфинитив без **te**; в perfectum — двойной инфинитив. |
| ⭐ | **durven + infinitief** | осмеливаться что-либо сделать | durf te lopen; durft te lopen; durft te lopen; durft te lopen; durven te lopen | durfde te lopen; durfden te lopen | heeft durven lopen | В современном языке возможны варианты с **te** и без **te**. |
| ⭐ | **mogen + infinitief** | можно, иметь разрешение | mag eten; mag eten; mag/mogen eten; mag eten; mogen eten | mocht eten; mochten eten | heeft mogen eten | Инфинитив без **te**; **niet mogen** — нельзя. |
| ✅ | **willen + infinitief** | хотеть что-либо сделать | wil zitten; wilt/wil zitten; wilt zitten; wil zitten; willen zitten | wilde/wou zitten; wilden/wouden zitten | heeft willen zitten | Инфинитив без **te**; конструкция уже отмечена в `KNOWN.md`. |
|  | **zullen + infinitief** | будущее, намерение или предположение | zal uitkijken; zult/zal uitkijken; zult/zal uitkijken; zal uitkijken; zullen uitkijken | zou uitkijken; zouden uitkijken | обычно заменяется другой конструкцией | Инфинитив без **te**. |

## Короткий приоритет A1+

В первую очередь стоит выучить не весь список со звёздочками сразу, а следующие группы:

1. **Базовые действия:** **gaan, komen, lopen, zitten, staan, liggen, doen, maken, eten, drinken, slapen, kijken, zien, zeggen, vragen, geven, krijgen**.
2. **Частые неправильные формы:** **ging — is gegaan**, **kwam — is gekomen**, **zag — heeft gezien**, **deed — heeft gedaan**, **gaf — heeft gegeven**, **kreeg — heeft gekregen**, **at — heeft gegeten**, **lag — heeft gelegen**, **zat — heeft gezeten**, **stond — heeft gestaan**.
3. **Повседневные модели:** **houden van**, **pijn doen**, **op bezoek komen**, **met rust laten**, **proberen te + infinitief**, **mogen + infinitief**.
4. **Позиционные конструкции:** **zitten / staan / liggen te + infinitief** — находиться в определённом положении и одновременно что-либо делать.
5. **Отделяемые глаголы:** узнавать рамочную конструкцию, например **ik doe de deur open** ↔ **ik heb de deur opengedaan**.
